...
const TransactionHistory = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <StyledAppBar>
        <Toolbar>
          <IconButton edge="start" color="inherit" onClick={() => navigate('/')} aria-label="戻る">
            <ArrowBackIcon />
          </IconButton>
      ...
      <FloatingActionButton color="primary" aria-label="請求履歴" onClick={() => navigate('/paymentdetail')}>
        <ReceiptIcon />
